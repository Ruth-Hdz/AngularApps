...
@Component({
  selector: 'app-assm-convertidor-assm',
  templateUrl: './convertidor-assm.component.html',
  styleUrls: ['./convertidor-assm.component.css']
})
export class ConvertidorAssmComponent implements OnInit {
